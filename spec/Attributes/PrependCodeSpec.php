...
use hanneskod\readmetester\Attributes\PrependCode;
...
class PrependCodeSpec extends ObjectBehavior
{
    ...
    function it_transforms_code(ExampleObj $example)
    {
        ...
        $example->withCodeBlock(new CodeBlock('foobar'))->willReturn($example)->shouldBeCalled();
    ...
    {
        $this->beConstructedWith('');
        $this->createAttribute('foo')->shouldReturn('\hanneskod\readmetester\Attributes\PrependCode("foo")');
    }
}
